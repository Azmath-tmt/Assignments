...
// ------------------------------ By Creating 3 Objects removed Duplicates... -------------------------------------
//
class Assignment1 implements Comparable<Assignment1>{
    ...
    public Assignment1(int id, String name, String gender, int salary){
        this.id = id;
        this.name = name;
        this.gender = gender;
        this.salary = salary;
    ...
    public int compareTo(Assignment1 a2){

        if(this.name.compareTo(a2.name) !=0){
            return this.name.compareTo(a2.name);
        }
        else if(this.gender.compareTo(a2.gender) !=0 ){
            return this.gender.compareTo(a2.gender);
        }
        else {
...
class Task{
    public static void main(String[] args) {
        ...
        TreeSet<Assignment1> set = new TreeSet<Assignment1>();
...
//
        for(int i=0; i<2; i++){
            ...
            Assignment1 a1 = new Assignment1(id, name, gender.toLowerCase(), salary);
            Assignment1 a2 = new Assignment1(id, name, gender.toLowerCase(), salary);
            Assignment1 a3 = new Assignment1(id, name, gender.toLowerCase(), salary);
...
//
            set.forEach(val -> System.out.println(val.getId() + " " + val.getName() + " " + val.getGender() + " " + val.getSalary()));

//                    -----OR------


//            set.stream().map(val -> val.getId() +  val.getName() + val.getGender() + val.getSalary())
...
//
//
//                Assignment5 a1 = new Assignment5(id, name, gender.toLowerCase(), salary);
//                Assignment5 a2 = new Assignment5(id, name, gender.toLowerCase(), salary);
//                Assignment5 a3 = new Assignment5(id, name, gender.toLowerCase(), salary);
////
//
//                set.add(a1);
//                set.add(a2);
...
// Assignment -6   Find the highest palindrome ....
...
class Palindrome {
    ...
    public static void  highestPalindrome(String s){
